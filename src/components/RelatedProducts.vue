    ...
    <div class="relate-container">
      ...
      <div class="wrapper-right">
        ...
        <div class="right-item item-exrta">
          <div class="item">
            <a href="https://item.mi.com/1160400027.html">
              <p>
                <span class="title">鼠标垫加大号</span>
          ...
          <div class="item more">
            <a href="https://list.mi.com/20">
              <p>
                <span class="title">浏览更多</span>
                <span class="text">生活周边</span>
              </p>
              <img :src="pic_3">
            </a>
          </div>
...
export default {
  data(){
    return{
      ...
      selected: '',
      selected_left: '',
      pic_2: './static/img/relate-r-8.jpg',
      pic_3: './static/img/right.png',
      wrapLeft: [
        {imgUrl: './static/img/relate-l-1.jpg', link: 'https://www.mi.com/ts-sunglasses/'},
        {imgUrl: './static/img/relate-l-2.jpg', link: 'https://item.mi.com/1164700015.html'}
      ],
      Items: [
        ...
        {title: '小米电源线收纳盒', text: '3609人评价', price: '49元', imgUrl: './static/img/relate-r-7.jpg', link: 'https://item.mi.com/1154900068.html'}
      ],
